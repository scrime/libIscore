...
QMAKE    = /usr/bin/qmake
Iscore.pbproj/project.pbxproj: iscore.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Iscore.pbproj/project.pbxproj iscore.pro
